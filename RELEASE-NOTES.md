...
`koollook-0.7.1.tar.zst` is the full bundle (every piece + chooser `install.sh`).

```bash
tar -I zstd -xf koollook-0.7.1.tar.zst
cd koollook-0.7.1
./install.sh --help
...
| File | What |
|------|------|
| `koollook-0.7.1.tar.zst` | Full bundle + chooser `install.sh` |
| `com.koollook.*.plasmoid` | Single widgets (Store-style) |
| `koollook-colors-0.7.1.tar.zst` | Color schemes |
| `koollook-icons-0.7.1.tar.zst` | Griffin icons |
| `koollook-titlebar-0.7.1.tar.zst` | KoollooK title bar |
| `koollook-dotted-0.7.1.tar.zst` | Koollook Dotted title bar |
| `koollook-splash-0.7.1.tar.zst` | Plasma splash (KoollooK) |
| `koollook-sddm-0.7.1.tar.zst` | Login theme |
| `koollook-plymouth-0.7.1.tar.zst` | Boot splash |
| `koollook-wallpaper-0.7.1.tar.zst` | Default wallpaper |
| `koollook-wallpaper-1` … `7` | Extra wallpapers (large) |
| `koollook-accessibility-0.7.1.tar.zst` | STT helper |
