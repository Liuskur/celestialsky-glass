# Celestial Sky (Glass) — `com.riderlook.celestialsky` v1.3.9
...
## Install
```bash
kpackagetool6 -t Plasma/Applet -i com.riderlook.celestialsky-1.3.9.plasmoid
# upgrade:
kpackagetool6 -t Plasma/Applet -u com.riderlook.celestialsky-1.3.9.plasmoid
```
