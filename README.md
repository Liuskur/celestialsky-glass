...
|--------|-----------|---------|
| Koollook Planisphere | `com.koollook.planisphere` | 0.7.3 |
| Koollook Calendar | `com.koollook.calendar` | 0.7.3 |
| Koollook Weather | `com.koollook.weather` | 0.7.3 |
| Koollook Muhurta | `com.koollook.muhurta` | 0.7.3 |
| Koollook Hora | `com.koollook.hora` | 0.7.3 |
| Koollook STT Clip | `com.koollook.sttclip` | 0.7.3 |
| Koollook STT | `com.koollook.stt` | 0.7.3 |
| Koollook Wavebar | `com.koollook.audioviz` | 0.7.3 |
