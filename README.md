...
|--------|-----------|---------|
| Koollook Planisphere | `com.koollook.planisphere` | 0.7.4 |
| Koollook Calendar | `com.koollook.calendar` | 0.7.4 |
| Koollook Weather | `com.koollook.weather` | 0.7.4 |
| Koollook Muhurta | `com.koollook.muhurta` | 0.7.4 |
| Koollook Hora | `com.koollook.hora` | 0.7.4 |
| Koollook STT Clip | `com.koollook.sttclip` | 0.7.4 |
| Koollook STT | `com.koollook.stt` | 0.7.4 |
| Koollook Wavebar | `com.koollook.audioviz` | 0.7.4 |
...
- One tarball per piece (download only what you want):
  - `koollook-colors-0.7.4.tar.zst`
  - `koollook-icons-0.7.4.tar.zst`
  - `koollook-plasma-0.7.4.tar.zst` (Plasma style)
  - `koollook-titlebar-0.7.4.tar.zst` (KoollooK title bar)
  - `koollook-dotted-0.7.4.tar.zst` (Koollook Dotted)
  - `koollook-splash-0.7.4.tar.zst` (Plasma splash, wordmark **KoollooK**)
  - `koollook-sddm-0.7.4.tar.zst`
  - `koollook-plymouth-0.7.4.tar.zst`
  - `koollook-wallpaper-0.7.4.tar.zst` plus `koollook-wallpaper-1` … `7`
  - `koollook-accessibility-0.7.4.tar.zst`
- Full bundle: `koollook-0.7.4.tar.zst` (every piece + `install.sh`)
